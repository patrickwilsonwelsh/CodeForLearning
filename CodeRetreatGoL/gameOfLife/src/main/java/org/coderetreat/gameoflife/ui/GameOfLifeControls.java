...
public class GameOfLifeControls extends Panel {
	...
	private List<GameOfLifeControlsListener> listeners;
	...
	public GameOfLifeControls() {
		listeners = new ArrayList<GameOfLifeControlsListener>();
	...
	public void startStopButtonClicked() {
		...
		for (GameOfLifeControlsListener listener : listeners) {
			listener.startStopButtonClicked(event);
		}
	}
	...
	public void nextButtonClicked() {
		GameOfLifeControlsEvent event = new GameOfLifeControlsEvent(this);
		for (GameOfLifeControlsListener listener : listeners) {
			listener.nextButtonClicked(event);
		}
	}
